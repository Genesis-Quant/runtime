    ...
    *,
    ...
    try:
        query, output_columns = build_query_table(
            ...
            computed_ref="coreQueryResultUnfilteredData",
            filtered_ref="coreQueryResultFilteredData",
        )
        current_session.run(
            """
...
__all__ = ["QueryResult", "build_query_table", "execute_query"]
